...
import {blueA700,pinkA700,green600,yellowA400,whiteA100,
  grey600,
  ...
  render(){
    return(
      ...
      <img src = {this.props.data.Cover} className="coverImage" alt = {this.props.Name+"'s Header Pic"}
          style={{position:"absolute",zIndex:"85",border:"1px ridge blue",borderTop:"4px ridge blue",width:"287px",height:"95px",
          boxShadow:"-5px -5px 50px -5px #D50000"}}/>
      <Paper zDepth={3} 
        style={{backgroundColor:grey600,position:"absolute",top:"45%",
...
export class TrendsBox extends React.Component{
  render(){
    return(
      ...
      <h1 style={{paddingLeft:"10px",borderBottom:"1px solid blue",backgroundColor:"rgb(0, 191, 255)"}}>Trending</h1>
            <div id ="trend_tags">
              {
...
const deta = ['Virat Kohli', 'Suresh Raina', 'Joe root', 'Brendon Mccullum', 'Steve Smith', 'ABDE Velliers', 'Sachin Tendulkar', 'Hardik Pandya'];
  ...
  render(){
     return(
        ...
        <FlatButton
          ...
          />
        <Paper zDepth={3} style={{backgroundColor :blueA400,display:"flex",position:"fixed",width:"98.75%",zIndex:"98"}}>  
        ...
        />
        <SearchBar/>
        <Avatar src="https://lh3.googleusercontent.com/-s9zHS3mFy0A/WeAtmoTynFI/AAAAAAAAUtI/hvB8OLmJWZwUEUmDaU9Z4rZuOJcG0egggCEwYBhgL/w140-h140-p/IMG_4940.JPG" alt="Profile<->Settings" style={{marginTop:"1%",marginBottom:"0.25%",marginLeft:"25%",marginRight:"2.5%",
           boxShadow:"rgba(0, 0, 0, 0.3) 0px 19px 60px, rgba(0, 0, 0, 0.22) 0px 15px 20px"}}/>
          <Popover
            open={this.state.open}
  ...
  render(){
    return(
      <Paper zDepth={3}
         ...
         boxShadow:"5px 5px 50px #D50000",backgroundImage:"url('starry_bg.png')",border:"1px solid blue"}}>
         <h2 style={{paddingLeft:"10px",borderBottom:"1px solid blue",backgroundColor:"rgb(0, 191, 255)"}}>Follow Recommendation</h2>
         <div>{this.props.userList.map((item)=>
            <div className = 'UserPanelCondensed' id = {'upc'+(item.key+1).toString()} key = {(item.key+1).toString()}>
              ...
              <a href='javascript:void(0);' style={{marginLeft:'15px',color:"rgb(0, 191, 255)"}}>
...
TrendsBox.defaultProps = {
  style: {
    ...
    boxShadow:"5px 5px 50px #D50000",border:"1px solid blue"
  }
}
    ...
    return(
      <div id = {this.props.id} className="usercards" 
        ...
        <img src = {this.props.Cover} className="coverImage" alt={this.props.Name+"'s Header Picture."}
            style={{position:"absolute",zIndex:"96",border:"1px ridge blue",borderTop:"4px ridge blue",width:"287px",height:"95px",
            boxShadow:"-5px -5px 50px -5px #D50000"}}/>
        <Paper zDepth={3} 
          style={{backgroundColor:blueA400,position:"absolute",top:"100px",
    ...
    return(
      <Paper zDepth={3} className = "Feeds-container"
        style={{backgroundColor:"#000",width:"50%",
         ...
         boxShadow:"5px 5px 50px #D50000", backgroundImage:"url('starry_bg_std.png')",border:"1px solid blue"}}>
         {this.props.feedList.map((item)=>
         <div>
          <Paper zDepth={3} className = "Feed" key={item.key}
            style={{backgroundColor:"rgb(0, 191, 255)",width:"95%",height:"auto", margin:"2.5%",
            boxShadow:"5px 5px 50px #D50000",border:"1px solid blue"}}>
            ...
            <div>7
              <IconButton style={{marginLeft:"50px",marginRight:"50px",marginTop:"10px"}} tooltip="Post your view">
                <FontIcon className="material-icons" hoverColor="#0099FF"
                  onClick={(e)=>e.target.style = "color:#0099FF !important"}>
                  Comment
                </FontIcon>
              </IconButton>
              <IconButton style={{marginLeft:"50px",marginRight:"50px",marginTop:"10px"}} tooltip="Retweet">
              ...
              <IconButton style={{marginLeft:"50px",marginRight:"50px",marginTop:"10px"}} tooltip="Inbox">
